...
export default function WidgetRenderer({ type, data, config }) {
  ...
  switch (type) {
    case 'CHART_BAR':
      return <RenderBarChart data={data} config={config} />;
    case 'CHART_LINE':
      return <RenderLineChart data={data} config={config} />;
    case 'CHART_PIE':
      return <RenderPieChart data={data} config={config} />;
    case 'CHART_AREA':
      return <RenderAreaChart data={data} config={config} />;
    case 'KPI_CARD':
      return <RenderKpiCard data={data} config={config} />;
    case 'TABLE':
      return <RenderTable data={data} config={config} />;
    case 'GAUGE':
